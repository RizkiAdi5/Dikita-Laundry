...
@section('title', 'Edit Karyawan - LaundryDikita')
...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
        <div class="p-6 border-b border-gray-200">
            ...
            <p class="text-sm text-gray-500 mt-1">Perbarui informasi karyawan {{ $employee->name }}</p>
        </div>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="address" rows="3" 
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                  placeholder="Alamat lengkap karyawan">{{ $employee->address }}</textarea>
                    </div>
                </div>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="salary" value="{{ $employee->salary }}" min="0" step="100000"
                    ...
                    <div>
                        ...
                        <textarea name="notes" rows="3" 
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                  placeholder="Catatan tambahan tentang karyawan">{{ $employee->notes }}</textarea>
                    </div>
