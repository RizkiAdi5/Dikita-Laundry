...
@section('title', 'Edit Layanan - LaundryDikita')
...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
        <div class="p-6 border-b border-gray-200">
            <h3 class="text-lg font-semibold text-gray-900">Edit Layanan: {{ $service->name }}</h3>
            <p class="text-sm text-gray-500 mt-1">Perbarui informasi layanan yang dipilih</p>
        </div>
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="description" rows="3" 
                              class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                              placeholder="Deskripsi singkat tentang layanan ini">{{ $service->description }}</textarea>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="unit" required 
                            ...
                            <option value="piece" {{ $service->unit == 'piece' ? 'selected' : '' }}>Piece</option>
                            <option value="set" {{ $service->unit == 'set' ? 'selected' : '' }}>Set</option>
                            <option value="m2" {{ $service->unit == 'm2' ? 'selected' : '' }}>Meter Persegi (m²)</option>
                        </select>
                ...
                <div class="bg-gray-50 rounded-lg p-4">
                    <h4 class="text-sm font-medium text-gray-700 mb-3">Informasi Layanan</h4>
                    <div class="grid grid-cols-2 gap-4 text-sm">
                        ...
                        <div>
                            <span class="text-gray-500">ID Layanan:</span>
