...
class InventoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validator = Validator::make($payload, [
            ...
            'category' => 'required|in:detergent,fabric_softener,bleach,plastic_bag,hanger,equipment,other,detergen,pelembut,pemutih,plastik,gantungan,peralatan,parfum,pembersih_noda,lainnya',
